...
#define APPEXE "setupdir\bin\rxclient.exe"
#include "version.iss"
...
#endif
UninstallDisplayIcon={app}\bin\rxclient.exe
...
#if BUILDXMING == "no"
Source: setupdir\bin\rxclient.exe; DestDir: {app}; DestName: nxclient.exe; Flags: restartreplace replacesameversion uninsrestartdelete
#endif

[Icons]
Name: "{group}\RX Client"; Filename: "{app}\bin\rxclient.exe";
Name: "{group}\{cm:cwizard}"; Filename: "{app}\bin\rxclient.exe"; Parameters: "--wizard"; IconFilename: "{app}\bin\rxclient.exe"; IconIndex: 2;
Name: "{group}\{cm:sadmin}"; Filename: "{app}\bin\rxclient.exe"; Parameters: "--admin"; IconFilename: "{app}\bin\rxclient.exe"; IconIndex: 3
Name: "{group}\{cm:doc_pconnect}"; Filename: "{app}\share\pconnect.html";
Name: "{group}\{cm:uninst_opennx}"; Filename: "{uninstallexe}";
Name: "{commondesktop}\RX Client"; Filename: "{app}\bin\rxclient.exe"; Tasks: "desktopicon";
