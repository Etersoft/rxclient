...
#define ID_WIZARD_SYMBOL_0 _("Connection Wizard - RX Client")
#define ID_WIZARD_SYMBOL_1 _("Welcome to the RX Client Connection Wizard which will guide you through the steps needed to setup your login. Please select the 'Next' button to start.")
...
#define ID_WIZARD_SYMBOL_13 _("Using RX Client, you can run RDP, VNC and X desktops, depending on what your service provider has made available.")
...
#define ID_WIZARD_SYMBOL_33 _("RX Client supports authentication using a variety of USB SmartCard tokens. Enable this option if you intend to use such a token.")
